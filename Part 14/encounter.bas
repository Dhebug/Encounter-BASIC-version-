 ...
 10 PRINT:PRINT"Sorry, can't do that":GOTO10000
 11 PRINT:PRINT"Eh ??":GOTO10000
 12 PRINT:PRINT"Come again ?":GOTO10000
 13 PRINT:PRINT"Let's try again, eh":GOTO10000
 14 PRINT:PRINT"You aren't carrying one":GOTO10000
 15 PRINT:PRINT"Sorry, that's full":GOTO10000
 16 PRINT:PRINT"Okay":GOTO10000
 17 PRINT:PRINT"You will have to DROP something":GOTO10000
 18 PRINT:PRINT"Your bottle is full":GOTO10000
 19 PRINT:PRINT"Your bucket is full":GOTO10000
 ...
 100 GOSUB50100:CLS:PL=3:BD=4:KY=5:YP=7:BU=8:RO=8:WA=8:PG=9:BX=14:TW=14:KN=16:NE=17
 ...
 103 AC=99:PU=99:AB=99:BB=99:BM=99:LP=99:HD=99:OS=99:GF=99:CP=20:PO=99:EC=8

 ' List of all locations
 1000 A=1:D$="You are in a deserted market square":GOSUB50200
 1001 IF GL=0THENPRINT"and you have made it - WELL DONE":P=P+200:EC=1:GOTO30020 ' Victory!
 1002 GOSUB8900:D$="Exits lead North and East":GOSUB50220
 1003 GT=1003:LK=1000:N=1030:E=1010:GOTO9900

 1010 A=2:D$="You are in a dark, seedy alley":GOSUB50200
 1011 GOSUB8900:D$="Exits lead North, East and West":GOSUB50220
 1013 GT=1013:LK=1010:N=1040:E=1020:W=1000:GOTO9900

 1020 A=3:D$="A long road stretches ahead of you":GOSUB50200
 1021 GOSUB8900:D$="Exits lead North and West":GOSUB50220
 1023 GT=1023:LK=1020:N=1050:W=1010:GOTO9900

 1030 A=4:D$="You are in a dark, damp tunnel":GOSUB50200
 1031 GOSUB8900:D$="Exits lead North and South":GOSUB50220
 1033 GT=1033LK=1030:N=1080:S=1000:GOTO9900

 1040 A=5:D$="You are on the main street":GOSUB50200
 1041 GOSUB8900:D$="Exits lead North, South and East":GOSUB50220
 1043 GT=1043:LK=1040:N=1090:S=1010:E=1050:GOTO9900

 1050 A=6:D$="You are on a narrow path":GOSUB50200
 1051 GOSUB8900:D$="Exits lead North, South, East and West":GOSUB50220
 1053 GT=1053=LK=1050:N=1100:S=1020:E=1060:W=1040:GOTO9900

 1060 A=7:D$="You have fallen into a deep pit":GOSUB50200
 1061 GOSUB8900:D$="There seems to be no way out":GOSUB50220
 1063 GT=1063:LK=1060:GOSUB10000
 1065 IFOP=1THENOP=0:GOTO1050
 1069 GOTOGT

 1070 A=8:D$="You are near to an old-fashioned well":GOSUB50200
 1071 GOSUB8900:D$="Exit to the East only":GOSUB50220
 1073 GT=1073:LK=1070:E=1080:GOTO9900

 1080 A=9:D$="You are in a wooded avenue":GOSUB50200
 1081 GOSUB8900:D$="Exits lead North, South, East and West":GOSUB50220
 1083 GT=1083:LK=1080:N=11110:S=1030:E=1090:W=1070:GOTO9900

 1090 A=10:D$="You are on a wide gravel drive":GOSUB50200
 1091 GOSUB8900:D$="Exits lead North, South, East and West":GOSUB50220
 1093 GT=1093:LK=1090:N=1120:S=1040:E=1100:W=1080:GOTO9900

 1100 A=11:D$="You are in an open area of tarmac":GOSUB50200
 1101 GOSUB8900:D$="Exits lead North, South and West":GOSUB50220
 1103 GT=1103:LK=1100:N=1130:S=1050:W=1090:GOTO9900

 1110 A=12:D$="You are in a relaxing zen garden":GOSUB50200
 1111 GOSUB8900:D$="Exits lead North and South":GOSUB50220
 1113 GT=1113:LK=1110:N=1140:S=1080:GOTO9900

 1120 A=13:D$="You are on a huge area of lawn":GOSUB50200
 1121 GOSUB8900:D$="Exits lead North, South and East":GOSUB50220
 1123 GT=1123:LK=1120:N=1200:S=1090:E=1130:GOSUB10000
 1124 IF(LEFT$(A$,1)="N")AND(LD=0)THENPRINT"The ladder does not fit":GOTO1123
 1126 GOTOGT

 1130 A=14:D$="You are in a small greenhouse":GOSUB50200
 1131 GOSUB8900:D$="Exits lead North, South and West":GOSUB50220
 1133 GT=1133:LK=1130:N=1150:S=1100:W=1120:GOTO9900

 1140 A=15:D$="You are on a lawn tennis court":GOSUB50200
 1141 GOSUB8900:D$="Exits lead North and South":GOSUB50220
 1143 GT=1143:LK=1140:N=1160:S=1110:GOTO9900

 1150 A=16:D$="You are in a vegetable plot":GOSUB50200
 1151 GOSUB8900:D$="Exits lead North snd South":GOSUB50220
 1153 GT=1153:LK=1150:N=1180:S=1130:GOTO9900

 1160 A=17:D$="You are standing by a fish pond":GOSUB50200
 1161 GOSUB8900:D$="Exits lead South and East":GOSUB50220
 1163 GT=1163:LK=1160:S=1140:E=1170:GOTO9900

 1170 A=18:D$="You are on a tiled patio":GOSUB50200:PRINT"Above is a barred window" 
 1171 GOSUB8900:D$="Exits lead South, East and West":GOSUB50220
 1173 GT=1173:LK=1170:S=1280:E=1180:W=1160:GOSUB10000
 1175 IF(LEFT$(A$,1)="S")AND(LD=0)THENPRINT"The ladder does not fit":GOTO1173
 1179 GOTOGT

 1180 A=19:D$="You are in an apple orchard":GOSUB50200
 1181 GOSUB8900:D$="Exits lead South and West":GOSUB50220
 1183 GT=1183:LK=1180:S=1150:W=1170:GOTO9900

 1190 A=23:D$="You are in the lounge":GOSUB50200
 1191 GOSUB8900:D$="Exits lead North and East":GOSUB50220
 1193 GT=1193:LK=1190:N=1230:E=1200:GOTO9900

 1200 A=24:D$="You are in an imposing entrance hall":GOSUB50200
 1201 GOSUB8900:IFAV=1THEN9100
 1202 D$="Exits lead North, South, West and up":GOSUB50220
 1203 GT=1203:LK=1200:N=1250:S=1120:U=1240:W=1190:GOTO9900

 1210 A=25:D$="This looks like a library." :GOSUB50200
 1211 GOSUB8900:D$="The only exit is West":GOSUB50220
 1213 GT=1213:LK=1210:W=1250:GOTO9900

 1230 A=26:D$="A dining room, or so it appears" :GOSUB50200
 1231 GOSUB8900:D$="Exits lead North and South":GOSUB50220
 1233 GT=1233:LK=1230:N=1270:S=1190:GOTO9900

 1240 A=27:D$="You are on a sweeping staircase":GOSUB50200
 1241 GOSUB8900:D$="Choose up or down":GOSUB50220
 1243 GT=1243:LK=1240:U=410:D=1200:GOTO9900

 1250 A=31:D$="You are in a narrow passage":GOSUB50200
 1251 GOSUB8900:D$="Exits lead North, South and East":GOSUB50220
 1253 GT=1253:LK=1250:N=1280:S=1200:E=1210:GOTO9900

 1260 A=22:D$="You are on some gloomy, narrow steps":GOSUB50200
 1261 GOSUB8900:D$="Choose up or down":GOSUB50220
 1263 GT=1263:LK=1260:U=290:D=1300:GOTO9900

 1270 A=28:D$="This looks like a games room":GOSUB50200
 1271 GOSUB8900:D$="Exits lead South and East":GOSUB50220
 1273 GT=1273:LK=1270:S=1230:E=1280:GOTO9900

 1280 A=29:D$="You find yourself in a sun-lounge":GOSUB50200
 1281 GOSUB8900:D$="Exits lead North, South, East and West":GOSUB50220
 1283 GT=1283:LK=1280:N=1170:S=1250:E=1290:W=1270:GOTO9900

 1290 A=30:D$="This is obviously the kitchen":GOSUB50200
 1291 GOSUB8900:D$="Exits lead West and down":GOSUB50220
 1293 GT=1293:LK=1290:D=1260:W=1280:GOTO9900

 1300 A=21:D$="This is a cold, damp cellar":GOSUB50200
 1301 GOSUB8900:D$="Exits lead South and up":GOSUB50220
 1303 GT=1303:LK=THEN1300:S=1310:U=1260:GOTO9900

 1310 A=20:D$="This room is even darker than the last":GOSUB50200
 1311 GOSUB8900:D$="The only way out is North":GOSUB50220
 1313 GT=1313:LK=1310:N=1300:GOTO9900

 1320 A=32:D$="This seems to be a guest bedroom":GOSUB50200
 1321 GOSUB8900:D$="The only exit it North":GOSUB50220
 1323 GT=1323:LK=1320:N=1400:GOTO9900

 1330 A=33:D$="This is a child's bedroom":GOSUB50200
 1331 GOSUB8900:D$="Exit to the North only":GOSUB50220
 1333 GT=1333:LK=1330:N=1360:GOTO9900

 1340 A=34:D$="This must be the master bedroom":GOSUB50200
 1341 GOSUB8900:D$="Exits lead North and West":GOSUB50220
 1343 GT=1343:LK=1340:N=1370:W=1360:GOTO9900
 
 1350 A=35:D$="You are in a tiled shower-room":GOSUB50200
 1351 GOSUB8900:D$="Exit to the North only":GOSUB50220
 1353 GT=1353:LK=1350:N=1380:GOTO9900

 1360 A=37:D$="You have found the east gallery":GOSUB50200
 1361 GOSUB8900:D$="Exits North, South, East and West":GOSUB50220
 1363 GT=1363:LK=1360:N=1390:S=1330:E=1340:W=1410:GOTO9900
 
 1370 A=36:D$="This is a tiny toilet":GOSUB50200
 1371 GOSUB8900:D$="Exit to the South only":GOSUB50220
 1373 GT=1373:LK=1370:S=1340:GOTO9900

 1380 A=38:D$="This is a small box-room":GOSUB50200
 1381 GOSUB8900:D$="Exits to the South and East":GOSUB50220
 1383 GT=1383:LK=1380:S=1350:E=1400:GOTO9900
 
 1390 A=40:D$="You are in an ornate bathroom":GOSUB50200
 1391 GOSUB8900:D$="Exit to the South only":GOSUB50220
 1393 GT=1393:LK=1390:S=1360:GOTO9900

 1400 A=41:D$="This is the west gallery":GOSUB50200
 1401 GOSUB8900:D$="Exits lead North, South, East and West":GOSUB50220
 1403 GT=1403:LK=1400:N=1420:S=1320:E=1410:W=1380:GOTO9900
 
 1410 A=42:D$="You are on the main landing":GOSUB50200
 1411 GOSUB8900:D$="Exits lead East, West and down":GOSUB50220
 1413 GT=1413:LK=1410:W=1400:E=1360:D=1240:GOTO9900
 
 1420 A=39:D$="You see a padlocked steel-plated door":GOSUB50200
 1421 GOSUB8900:D$="You can return to the South":GOSUB50220
 1423 GT=1423:LK=1420:S=1400:GOTO9900
 ...
 9015 IFLD=ATHENPRINT"a ladder":IT=1:IF A=19 THEN !RESTORE 40100:CL=1:GOSUB 50700
 ...
 9024 IFBK=ATHENPRINT"a chemistry book":IT=1:IF A=25 THEN !RESTORE 40150:CL=0:GOSUB 50700 
 ...
 11077 IF(B$="DOG")AND(DG=A)AND(AV=0)THENDG=0:GOSUB8800:GOTO15000
 ...
 11088 PRINT:PRINT"I can't see ";BB$;" anywhere":GOTO10000 
 ...
 11162 IF(B$="BOT")AND(SB=0)THENPRINT:PRINT"*CRASH*TINKLE* There is a funny smell.":AB=A:BB=A:SB=99:GOTO10000
 11164 IF(B$="FUS")AND(FU=0)THENFU=A:GOTO1OOOO
 11165 PRINT:PRINT"Don't have ";BB$;" - check inventory":GOTO10000
 ...
 11206 IF(B$="GLA")AND(BB=0)THEN PRINT:PRINT"The fragments are too small to throw":GOTO10000
 ...
 ' Throw knife
 11250 IFDG=ATHENPRINT:PRINT"You have killed the dog":P=P+50:KN=A:AV=0:GOSUB8800:GOTO15000
 ...
 11275 GF=18:RH=18:RO=18:IC=IC-1:P=P+100:GOTO10000   ' Unused ???
 ...
 ' Strangle thug
 11370 IF(S$="TWI")AND(TW=0)THENPRINT:PRINT"CROAK":TW=A:IC=IC-1:GOTO11407
 11371 IF(S$="TWI")AND(TW<>0)THENPRINT:PRINT"You don't have any":GOTO10000
 11372 IF(S$="ROP")AND(RO=0)THENPRINT:PRINT"CROAK":RO=A:IC=IC-1:GOTO11407
 11373 IF(S$="ROP")AND(RO<>0)THENPRINT:PRINT"You don't have any":GOTO10000 
 11374 IF(S$="HOS")AND(HP=0)THENPRINT:PRINT"CROAK":HP=A:IC=IC-1:GOTO11407
 11375 IF(S$="HOS")AND(HP<>0)THENPRINT:PRINT"You don't have one":GOTO10000
 11376 GOTO12 ' Come again ?

 ' Stab thug
 11380 IF(S$="KNI")AND(KN=0)THENPRINT:PRINT"Messy":KN=A:IC=IC-1:GOTO11407
 11381 IF(S$="KNI")AND(KN<>0)THENPRINT:PRINT"You don't have one":GOTO10000   
 11382 GOTO12 ' Come again ?

 ' Hit thug
 11390 IF(S$="CUE")AND(CU=0)THENPRINT:PRINT"KRUNCH":CU=A:IC=IC+:GOTO11407
 ...
 ' Make bomb
 11430 IF(FU=0)AND(GP=0)AND(TN=0)THENPRINT:PRINT"Bomb ready":FU=99:GP=99:TN=99:BM=A:IC=IC-2:EE=0:P=P+200:GOTO10000
 ...
 11573 PRINT:PRINT"I moved all your dangerous chemical":PRINT"products to the basement's safe - DAD":GOTO10000

 11580 IFB$<>"BOO"THEN11 ' Eh??
 11582 IF (BK<>0) AND (BK<>A) THEN11165
 11583 PRINT:PRINT"...making fuses... salpeter... explosive... acide and steel... Complicated stuff!":GOTO10000

 ' Quit
 11600 PRINT:PRINT"Giving up ???? - are you sure ?"
 11602 K$=KEY$:IFK$="Y"THENGU=1:GOTO30000
 ...
 11704 IFAR=1THENPOKE#26B,16+4:PLOT 21,26,"        ":PRINT:PRINT"Alarm stops ringing":PING:AR=0:P=P+200:GOTO10000
 ...
 15000 IFA$="GET"THENIC=IC+1:GOSUB 14000:A$="L"
 15001 IFA$="MAK"THENIC=IC-2:GOSUB 14000:A$="L"
 15002 IFA$="DRO"THENIC=IC-1:GOSUB 14000:A$="L"
 15003 IFA$="THR"THENIC=IC-1:GOSUB 14000:A$="L"
 15005 N=0:S=0:E=0:W=0:U=0:D=0:PRINT:IT=0:RETURN  

 ' Victory/Failure Condition check
 20000 IF AR=1 AND TM>19 THEN PRINT"You failed to silence the alarm":PRINT"in time and have been captured.":NM=NM*2:EC=5:GOTO30020 
 20002 NM=NM+1:IF NM>499 THEN PRINT"You have made your 500 moves":EC=6:GOTO30020
 ...
 30010 CLS:PRINT"You have been killed by the ";KL$:GOTO30020 

 ' Show game score
 30020 PRINT"Game score     ";P-NM" points":GOTO 50500
 ...
 50610 D$="New highscore! Your name please?":GOSUB50400
 50620 Q$="                "+Q$:L=LEN(Q$)
