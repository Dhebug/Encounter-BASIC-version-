 ...
 15 REPEAT
 16 PAPER3:INK4:F=FRE(0)
 20 HIRES:LOAD"TITLE.BIN":PRINT CHR$(17)
 21 K$=""
 22 POKE#26B,16+3:POKE#26C,4:CLS:PRINT:PRINT"  Encounter ";CHR$(96);" 1983 Severn Software":PRINT"Redux Additions ";CHR$(96);" 2018 Defence-Force";
 25 WT=500:GOSUB 1000
 26 CURSET0,0,0:FILL200,40,0:TEXT
 29 IF K$="" THEN WT=600:GOSUB 100
 30 IF K$="" THEN WT=1200:GOSUB 400
 35 IF K$="" THEN GOSUB 500
 40 UNTIL K$<>""

 50 CLS:PAPER0:INK0:POKE#BB80,0:POKE#BB80+35,0:Z$=CHR$(27)
 ...
 102 ' 
 110 PAPER0:CLS:DOKE #278,48000:DOKE #27A,48000:DOKE #27C,40*28:DOKE #27E,28:CLS:PRINT CHR$(17)
 111 LOAD"SCORES",N
